    ...
    UploadImage.prototype = {
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                        ...
                        $file.append('<span class="success"></span>');console.log(_this.imageList);
                    } else {
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                if(typeof(data) == 'undefined'){//源自于对line:(722或721)的修改，避免部分图片上传失败，或者选择的图片不符合规范不能参与上传而造成imageList数组中出现的undefined项
					continue;
				}
                list.push({
                    src: prefix + data.url,
