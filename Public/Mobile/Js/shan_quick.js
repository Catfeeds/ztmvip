  ...
  function change_payment(val)
  {
   ...
   var pay_way= $(val).next().val();
   var send={
          'pay_way':pay_way,
       };

          var url="/index.php?m=Mobile&c=Quick&a=changePayment";
          ...
          $.post(url,send,function(reback){
                ...
                }else if(reback.error=='nopassword')
                {
                    ...
                    if(result)
                    {
                        window.location.href="/index.php?m=mobile&c=User&a=safetyPay&redirect="+reback.url;
                    }
...
function change_card(This)
{
    ...
    var url="/index.php?m=Mobile&c=Quick&a=changeCard";
    var send={
  ...
  function change_bonus(val)
  {
     ...
     var url="/index.php?m=Mobile&c=Quick&a=changeBonus";
    var send={
       'bonus':bonus_id,
    };
  ...
  function change_coupon(val)
  {
     ...
     var url="/index.php?m=Mobile&c=Quick&a=changeCoupon";
    var send={
       'coupon':coupon_id,
    };
  ...
  function change_integral(val)
  {
   ...
   var url="/index.php?m=Mobile&c=Quick&a=changeIntegral";
  ...
  function checkout_before_done()
  {
        ...
        var url="/index.php?m=Mobile&c=Quick&a=beforeDone";
  ...
  function go_check_done()
  {
    ...
    var url="/index.php?m=Mobile&c=Quick&a=done";
