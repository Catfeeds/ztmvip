...
<div class="special">
    <ul class="special_l">
        <?php if(is_array($goods_brand)): $i = 0; $__LIST__ = $goods_brand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><img src="<?php echo ($vo["brand_logo"]); ?>" alt="<?php echo ($vo["brand_name"]); ?>" /></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
    <ul class="special_r">
        <?php if(is_array($special_buy)): $i = 0; $__LIST__ = $special_buy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo["link"]); ?>/id/<?php echo ($vo["id"]); ?>.html"><img src="<?php echo ($vo["hd_image"]); ?>" alt="<?php echo ($vo["title"]); ?>" /></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
</div>
  </body>
</html>
