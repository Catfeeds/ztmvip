...
<!-- banner -->
<div class="index_banner"><img  src="/Public/Computer/Images/index_02.jpg" alt="" /></div>
<!-- banner -->
...
<div class="release">
    <div class="con_left">
        <h3>新品首发</h3>
        <ul>
            <?php if(is_array($new_starts)): $i = 0; $__LIST__ = $new_starts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo ($vo["link"]); ?>/id/<?php echo ($vo["id"]); ?>.html"><img src="<?php echo ($vo["hd_image"]); ?>" alt="<?php echo ($vo["title"]); ?>" /></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
    </div>
    <div class="con_rigth">
         <h3>正在热卖</h3>
         <ul class="">
             <?php if(is_array($hot_goods)): $i = 0; $__LIST__ = $hot_goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                 <a href="<?php echo U('Goods/detail',array('goods_id'=>$vo['id']));?>">
                     <img src="<?php echo ($vo["goods_thumb"]); ?>" alt="<?php echo ($vo["goods_name"]); ?>" />
                     <p class="p1"><?php echo ($vo["goods_name"]); ?></p>
                     <p class="p2"><span>￥<?php echo ($vo["market_price"]); ?></span>￥<i><?php echo ($vo["shop_price"]); ?></i></p>
                 </a>
