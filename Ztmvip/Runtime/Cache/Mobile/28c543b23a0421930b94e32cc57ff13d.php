...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/Mobile/Css//car_mobile.css" media="(max-width:750px)" />
<link rel="stylesheet" type="text/css" href="/Public/Mobile/Css//car_pad.css" media="(min-width:750px)">
   ...
   $('.editor').on('click',function(event) {
       ...
       if(text == '编辑'){
           ...
           // $('.goods_num2').css('display', 'none');
            window.location.replace('<?php echo U('Flow/cart');?>');
       }
   });
