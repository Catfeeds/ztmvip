...
<script type="text/javascript" src="/Public/Mobile/Js//shan_flow.js"></script>
...
<!-- 订单确认头部开始 -->
<div class="header_box" onClick="window.location='<?php echo U('Flow/cart');?>'">
...
<div class="address_box">
 ...
 <!-- 添加修改地址 -->
    <div class="list_box">
        <a href="<?php echo U('Region/editConsignee',array('address_id'=>$consignee['address_id']));?>">
...
<div class="columns_box" class="integral">
    <label for="classify3" class="integral">
        <div class="list_box" style="padding-left:10px;">
            <div class="icon" style="display:none"><img src="/Public/Mobile/Images/icon7.jpg" alt="" /></div>
            使用积分
...
<!-- 商品 -->
<?php if(is_array($goods_list)): $key1 = 0; $__LIST__ = $goods_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($key1 % 2 );++$key1; if(($value["buy_flag"]) == "normal"): ?><!-- 正常商品进这里 -->
        <div class="columns_box">
            <div class="goods_box">
                <div class="goods_pho" style="border-color:#ccc"><img src="<?php echo ($value["goods_thumb"]); ?>_250x250.jpg" alt="" /></div>
                <div class="inf_box">
                    <div class="goods_inf"><?php echo ($value["goods_name"]); ?></div>
                    <div class="price">￥<i><?php echo ($value["goods_price"]); ?></i>       ×   <?php echo ($value["goods_number"]); ?></div>
                    <div>
...
<div class="card_bg integralin">
    <div class="integral_box">
        <div class="integralin_now">
            ...
            本订单最多可使用积分：<?php echo ($order_max_integral); ?>
        </div>
