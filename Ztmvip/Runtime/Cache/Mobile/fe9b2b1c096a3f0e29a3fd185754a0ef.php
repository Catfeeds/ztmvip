...
<!-- 特卖专场头部结束 -->
<!-- 特卖专场展示开始 -->
<?php if(!empty($newStarting)): ?><div class="sale_banner">
    <?php if(is_array($newStarting)): $i = 0; $__LIST__ = $newStarting;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="banner"><a href="<?php echo ($vo["link"]); ?>/id/<?php echo ($vo["id"]); ?>.html"><img src="<?php echo ($vo["image"]); ?>" alt="" /></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
</div><?php endif; ?>
<!-- 特卖专场展示结束 -->
<!-- 版权开始 -->
